...
- `test-prompts.json` — 54 tests (V01-V54), machine-readable
...
- **Critical (20):** V02, V11, V12, V13, V29, V30, V31, V32, V33, V34, V40, V42, V44, V48, V49, V50, V51, V52, V53, V54 — approval gates, safety carve-outs, no silent execution, no overreach, Enforcement Bootstrap, plan decomposition
